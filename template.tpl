        ...
        "subParams": [
          {
            ...
            "simpleValueType": true,
            "alwaysInSummary": true,
            "help": "Please assign the array of transaction products here as detailed in your integration guide. This would typically be a variable macro such as {{Transaction Products}}",
            "valueValidators": []
          },
          {
            "type": "TEXT",
...
log("RakutenAdvertising - Conversion: built rm_trans", rm_trans);
// edited the conversion module to create a function rather than immediately call itself.

function onSuccess() {
	log("RakutenAdvertising - Conversion: calling conversion", rm_trans);
